...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, info: React.ErrorInfo) {
    console.error('[Draftsman] Uncaught error:', error, info.componentStack);
  }
  ...
  private handleClear = () => {
    localStorage.removeItem('draftsman.diagram.document');
      ...
      return (
        <div style={{ padding: 40, fontFamily: 'Inter, sans-serif', color: '#f8fafc', background: '#020617', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ maxWidth: 480, textAlign: 'center' }}>
            ...
            <p style={{ color: '#8899bb', marginBottom: 8 }}>Azure Local Draftsman encountered an unexpected error.</p>
